// Credits : http://wiki.unity3d.com/index.php/DrawLine
// Then fix because it didn't work
...
internal class Drawing
{
    ...
    public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width)
    {
        ...
        GUI.DrawTexture(new Rect(pointA.x, pointA.y - 0.5f * width, Vector3.Distance(pointA, pointB), width), lineTex);
